...
from pyramidbox.nets import custom_layers
import pyramidbox.tf_extended as tfe
from pyramidbox.nets import ssd_common
...
class PyramidBoxModel():
    ...
    def get_model(self,inputs, weight_decay=0.0005,is_training=False):
        ...
        with slim.arg_scope(arg_scope):
            end_points = {}
            channels={}
            with tf.variable_scope('vgg_16', [inputs], reuse=tf.AUTO_REUSE):
